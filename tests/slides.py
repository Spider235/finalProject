...
def review_menu(username):
    ...
    while running:
        ...
        previous_page_button_label_rect = previous_page_button_label.get_rect(center=previous_page_button_rect.center)
...
def sign_up_menu():
    ...
    # Define the fixed width for the input boxes
    fixed_input_width = 400
    input_rect1 = pygame.Rect(150, 200, fixed_input_width, 32)  # Initial position and dimensions of the first input box
    input_rect2 = pygame.Rect(150, 300, fixed_input_width,
                              32)  # Initial position and dimensions of the second input box
    input_rect3 = pygame.Rect(150, 400, fixed_input_width, 32)  # Initial position and dimensions of the third input box
